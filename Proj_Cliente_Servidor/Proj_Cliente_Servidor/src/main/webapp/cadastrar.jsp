...
<body>
	<div class="Header">
	<form action="/Proj_Cliente_Servidor/cadastrar">
			<label>Codigo do Livro:</label><br>
				<input class="textarea" type="text" name="idlivro"><br>
			<label>Titulo:</label><br>
				<input class="textarea" type="text" name="titu"><br>
			<label>Autor:</label><br>
				<input  class="textarea" type="text" name="aut"><br>
			<label>Categoria:</label><br>
				<select  class="textarea"  Name="categ"> 
		...
		<label>Valor:</label><br>
			<input  class="textarea"  type="text" name="val"><br>
